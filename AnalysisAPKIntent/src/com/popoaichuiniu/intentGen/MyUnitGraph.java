...
public class MyUnitGraph extends BriefUnitGraph {
    ...
    public MyUnitGraph(Body body, Unit targetUnit, String appPath) {
        super(body);
...
//        }
    ...
    public void reducedCFG(UnitGraph ug, IntentFlowAnalysis intentFlowAnalysis, Map<JimpleBody, Body> bodyMap, SimpleLocalDefs defs) {
        ...
        findAllUnitInToTargetUnitPath(targetUnit, ug, allUnitFromStartToTargetUnitInpath);


        Set<Unit> relativeUnitDefUnitSet = new HashSet<>(unitIntentRelativeAndStartStop);

        addUseLocalDefUnit(defs, needToRemove, relativeUnitDefUnitSet);
        ...
        WriteFile writeFile = new WriteFile("AnalysisAPKIntent/intentConditionSymbolicExcutationResults/" + "unitGraphSize.txt", true);
    ...
    private void addUseLocalDefUnit(SimpleLocalDefs defs, Set<Unit> needToRemove, Set<Unit> relativeUnitDefUnitSet) {
    ...
    public static void findUnRelativeNode(Unit targetUnit, SootMethod sootMethod, Set<Unit> unitNeedToRemove, IntentFlowAnalysis intentFlowAnalysis, UnitGraph ug, Set<Unit> unitIntentRelativeAndStartStop) {
    ...
    public static boolean isAboutIntentOrTargetAPI(Unit unit, IntentFlowAnalysis intentFlowAnalysis, Unit targetUnit) {
